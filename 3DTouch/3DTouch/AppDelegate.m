...
//    [self create3DTouchShotItems];//第一种
    //第二种方法是infoPlist写
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "www.unimker.com._DTouch" in the application's documents directory.
